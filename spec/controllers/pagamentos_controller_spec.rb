...
describe PagamentosController do
  ...
  describe "GET index" do
    it "assigns all pagamentoss as @pagamentoss" do
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved pagamento as @pagamento" do
        ...
        post :create, {:pagamento => { "valor" => "invalid value" }}, valid_session
        assigns(:pagamento).should be_a_new(Pagamento)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested pagamento" do
        ...
        Pagamento.any_instance.should_receive(:update_attributes).with({ "valor" => "1.5" })
        put :update, {:id => pagamento.to_param, :pagamento => { "valor" => "1.5" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the pagamento as @pagamento" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Pagamento.any_instance.stub(:save).and_return(false)
        put :update, {:id => pagamento.to_param, :pagamento => { "valor" => "invalid value" }}, valid_session
        assigns(:pagamento).should eq(pagamento)
      end
